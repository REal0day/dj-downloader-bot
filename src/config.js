...
export const config = {
  ...
  spotifyClientId:     (process.env.SPOTIFY_CLIENT_ID || process.env.spotify_client_id)?.trim() || '',
  spotifyClientSecret: (process.env.SPOTIFY_CLIENT_SECRET || process.env.spotify_client_secret)?.trim() || '',
  ...
  beatportCookiesFile: process.env.BEATPORT_COOKIES_FILE?.trim() || null,
